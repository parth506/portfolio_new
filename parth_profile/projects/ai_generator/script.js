...
const OPENAI_API_KEY = "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"; // Your OpenAI API key here
...
const generateAiImages = async (userPrompt, userImgQuantity) => {
  try {
    ...
    const response = await fetch("https://platform.openai.com/docs/api-reference", {
      method: "POST",
      headers: {
